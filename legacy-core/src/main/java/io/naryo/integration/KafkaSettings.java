...
public class KafkaSettings {
    ...
    @Value("${kafka.topic.naryoEvents}")
    private String naryoEventsTopic;
    ...
    public KafkaSettings(@Value("${server.port}") String port) {
        // Generate a random groupId as we want to receive all filter event messages in all
        // instances of
        // service
        initGroupId(port);
    }
    ...
    public String getNaryoEventsTopic() {
        return naryoEventsTopic;
    }
