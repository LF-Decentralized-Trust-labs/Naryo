...
@Component
public class MongoBroadcasterConfigurationSourceProvider implements BroadcasterConfigurationSourceProvider {

    private final BroadcasterConfigurationDocumentRepository repository;

    public MongoBroadcasterConfigurationSourceProvider(BroadcasterConfigurationDocumentRepository repository) {
    ...
    public Collection<BroadcasterConfigurationDescriptor> load() {
       List<BroadcasterConfigurationDocument> broadcasterConfigurations = this.repository.findAll();
