...
import io.naryo.infrastructure.configuration.persistence.document.filter.event.EventFilterSpecificationPropertiesDocument;

import java.util.stream.Collectors;

public abstract class EventFilterSpecificationDocumentMapper {

    public static EventFilterSpecification fromDocument(EventFilterSpecificationPropertiesDocument props) {
