package io.naryo.infrastructure.configuration.source.env.serialization.node.subscription.block.method;
...
import io.naryo.infrastructure.configuration.source.env.model.node.subscription.block.method.BlockSubscriptionMethodConfigurationProperties;
import io.naryo.infrastructure.configuration.source.env.model.node.subscription.block.method.BlockSubscriptionMethodProperties;
...
import io.naryo.infrastructure.configuration.source.env.model.node.subscription.block.method.PubSubBlockSubscriptionMethodConfigurationProperties;
