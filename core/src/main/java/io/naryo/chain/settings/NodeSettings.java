...
public class NodeSettings {
            ...
            while (nodeExistsAtIndex(environment, supportedChain, index)) {
                ...
                Node node =
                        new Node(
                                ...
                                getNodeHealthcheckIntervalProperty(
                                        environment, supportedChain, index),
                                getBlocksToWaitForConfirmationProperty(
                                        environment, supportedChain, index),
                                getBlocksToWaitBeforeInvalidatingProperty(
                                        environment, supportedChain, index),
                                getBlocksToWaitForMissingTxProperty(
                                        environment, supportedChain, index),
    ...
    private BigInteger getLimitMirrorNodeResults(
        ...
        String limitMirrorNodeResults =
                getProperty(
                        environment,
                        buildNodeAttribute(LIMIT_MIRROR_NODE_RESULTS, chainName, index));

        if (limitMirrorNodeResults == null) {
            // Get the generic configuration
            limitMirrorNodeResults =
                    environment.getProperty("hashgraph.nodes.limitMirrorNodeResults");
        }
    ...
    private boolean nodeExistsAtIndex(Environment environment, String chainName, int index) {
        return environment.containsProperty(
                buildNodeAttribute(NODE_NAME_ATTRIBUTE, chainName, index));
    }
    ...
    private BigInteger getNodeCallRetriesProperty(
        ...
        final String nodeCallRetries =
                getProperty(
                        environment,
                        buildNodeAttribute(NODE_CALL_RETRIES_ATTRIBUTE, chainName, index));
    ...
    private BigInteger getNodeLimitPerRequestProperty(
        ...
        final String nodeLimitPerRequest =
                getProperty(
                        environment,
                        buildNodeAttribute(NODE_LIMIT_PER_REQUEST_ATTRIBUTE, chainName, index));
    ...
    private Long getNodePollingIntervalProperty(
        ...
        final String pollingInterval =
                getProperty(
                        environment,
                        buildNodeAttribute(NODE_POLLING_INTERVAL_ATTRIBUTE, chainName, index));
    ...
    private Integer getMaxIdleConnectionsProperty(
        ...
        final String maxIdleConnections =
                getProperty(
                        environment,
                        buildNodeAttribute(MAX_IDLE_CONNECTIONS_ATTRIBUTTE, chainName, index));
    ...
    private Long getKeepAliveDurationProperty(
            Environment environment, String chainName, int index) {
        final String keepAliveDuration =
                getProperty(
                        environment,
                        buildNodeAttribute(KEEP_ALIVE_DURATION_ATTRIBUTTE, chainName, index));
    ...
    private Long getConnectionTimeoutProperty(
            Environment environment, String chainName, int index) {
        final String connectionTimeout =
                getProperty(
                        environment,
                        buildNodeAttribute(CONNECTION_TIMEOUT_ATTRIBUTE, chainName, index));
    ...
    private Long getReadTimeoutProperty(Environment environment, String chainName, int index) {
        final String readTimeout =
                getProperty(
                        environment, buildNodeAttribute(READ_TIMEOUT_ATTRIBUTTE, chainName, index));
    ...
    private Integer getSyncingThresholdProperty(
        ...
        final String syncingThreshold =
                getProperty(
                        environment,
                        buildNodeAttribute(SYNCING_THRESHOLD_ATTRIBUTE, chainName, index));
    ...
    private BigInteger getBlocksToWaitForConfirmationProperty(
        ...
        String blocksToWaitForConfirmation =
                getProperty(
                        environment,
                        buildNodeAttribute(
                                BLOCKS_TO_WAIT_FOR_CONFIRMATION_ATTRIBUTE, chainName, index));
    ...
    private BigInteger getBlocksToWaitBeforeInvalidatingProperty(
        ...
        String blocksToWaitBeforeInvalidating =
                getProperty(
                        environment,
                        buildNodeAttribute(
                                BLOCKS_TO_WAIT_BEFORE_INVALIDATING_ATTRIBUTE, chainName, index));
    ...
    private BigInteger getBlocksToWaitForMissingTxProperty(
        ...
        String blocksToWaitForMissingTx =
                getProperty(
                        environment,
                        buildNodeAttribute(
                                BLOCKS_TO_WAIT_FOR_MISSING_TX_ATTRIBUTE, chainName, index));
    ...
    private BigInteger getInitialStartBlockProperty(
        ...
        if (initialStartBlock != null) {
            ...
            initialStartBlock =
                    getProperty(
                            environment,
                            buildNodeAttribute(INITIAL_START_BLOCK_ATTRIBUTE, chainName, index));
        }
        if (initialStartBlock == null) {
            initialStartBlock =
    ...
    private BigInteger getNumBlocksToReplayProperty(
        ...
        String numBlocksToReplay =
                getProperty(
                        environment,
                        buildNodeAttribute(NUM_BLOCKS_TO_REPLAY_ATTRIBUTE, chainName, index));
    ...
    private BigInteger getMaxBlocksToSyncProperty(
        ...
        String maxBlocksToSync =
                getProperty(
                        environment,
                        buildNodeAttribute(
                                NODE_MAX_UNSYNCED_BLOCKS_FOR_FILTER_ATTRIBUTE, chainName, index));
        if (maxBlocksToSync == null) {
            maxBlocksToSync =
                    environment.getProperty(DEFAULT_MAX_UNSYNCED_BLOCKS_FOR_FILTER_ATTRIBUTE);
        }
        if (maxBlocksToSync != null) {
            logger.warn(
            ...
            maxBlocksToSync =
                    getProperty(
                            environment,
                            buildNodeAttribute(MAX_BLOCKS_TO_SYNC_ATTRIBUTE, chainName, index));
        }
        if (maxBlocksToSync == null) {
            maxBlocksToSync =
                    getProperty(
    ...
    private String getNodeUsernameProperty(Environment environment, String chainName, int index) {
        return getProperty(
                environment, buildNodeAttribute(NODE_USERNAME_ATTRIBUTE, chainName, index));
    }

    private String getNodePasswordProperty(Environment environment, String chainName, int index) {
        return getProperty(
                environment, buildNodeAttribute(NODE_PASSWORD_ATTRIBUTE, chainName, index));
    }

    private String getNodeBlockStrategyProperty(
            Environment environment, String chainName, int index) {
        return getProperty(
                environment, buildNodeAttribute(BLOCK_STRATEGY_ATTRIBUTE, chainName, index));
    }
    ...
    private Boolean getNodeTransactionRevertReasonProperty(
        ...
        return Boolean.parseBoolean(
                getProperty(
                        environment,
                        buildNodeAttribute(
                                TRANSACTION_REVERT_REASON_ATTRIBUTTE, chainName, index)));
    }
    ...
    private Long getNodeHealthcheckIntervalProperty(
        ...
        String healthcheckInterval =
                getProperty(
                        environment,
                        buildNodeAttribute(NODE_HEALTHCHECK_INTERVAL_ATTRIBUTE, chainName, index));
