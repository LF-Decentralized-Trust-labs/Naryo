package io.naryo.privacy.chain.service;

import java.io.IOException;
import java.time.Instant;
import java.util.Optional;

import io.naryo.config.BaseConfiguration;
import io.naryo.config.DatabaseConfiguration;
import io.naryo.dto.event.ContractEventDetails;
import io.naryo.privacy.chain.service.eth.MyContract;
...
import static io.naryo.privacy.chain.service.TestUtils.*;
...
*        Keep in mind that if you use a sql database, there must exist a database called naryo.
*
