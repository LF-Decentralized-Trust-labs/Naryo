...
@NoArgsConstructor
public final class BoolParameterEntity extends ContractEventParameterEntity<Boolean> {
    ...
    public static ContractEventParameterEntity<?> from(BoolParameter boolParameter) {
