...
public class HederaMirrorNodeBlockInteractionEntity extends BlockInteractionEntity implements HederaMirrorNodeBlockInteractionDescriptor {
    ...
    public HederaMirrorNodeBlockInteractionEntity(
        @Nullable Integer limitPerRequest,
        @Nullable Integer retriesPerRequest) {
        this.limitPerRequest = limitPerRequest != null ? limitPerRequest : DEFAULT_LIMIT_PER_REQUEST;
        this.retriesPerRequest = retriesPerRequest != null ? retriesPerRequest : DEFAULT_RETRIES_PER_REQUEST;
    }
