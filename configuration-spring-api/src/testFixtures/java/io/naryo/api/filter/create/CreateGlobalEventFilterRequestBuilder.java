...
public class CreateGlobalEventFilterRequestBuilder extends CreateFilterRequestBuilder<CreateGlobalEventFilterRequestBuilder, CreateGlobalEventFilterRequest> {
    ...
    public CreateGlobalEventFilterRequestBuilder withSpecification(EventFilterSpecificationRequest specification) {
    ...
    public CreateGlobalEventFilterRequestBuilder withFilterSyncState(FilterSyncStateRequest filterSyncState) {
        this.filterSyncState = filterSyncState;
        return self();
    }

    public CreateGlobalEventFilterRequestBuilder withVisibilityConfiguration(EventFilterVisibilityConfigurationRequest visibilityConfiguration) {
